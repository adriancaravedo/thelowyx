...
import { ArrowLeft, Users, Receipt, Grid3X3, Sliders, Settings, RefreshCw, Target, TrendingUp, LogOut, Camera } from "lucide-react";
...
export default function MenuSheet({ open, onClose, onSettingsOpen }: MenuSheetProps) {
  ...
  return (
    <Sheet open={open} onClose={onClose}>
      ...
      <button className="w-full py-3.5 bg-gray-50 rounded-2xl text-red-500 font-semibold text-sm">
        Sign out
      </button>
    </Sheet>
  );
